...
printf( "\n DO YOU KNOW ?\nThe liquid part of yogurt that sometimes separates on top, the whey, contains important nutrients such as calcium, potassium, and protein.\nDon’t drain it, mix it.\n");
 BMI(w,h);
 printf("\nThe Login-Logout Interface,Body Mass Index Classification Department as well as the color coding along with compilation of codes was taken care by Mr.Dhawal Shukla :}\n");
 getch();
 system("cls");
 printf( "\nDO YOU KNOW?\nYour pets should never eat raisins, grapes, macadamia nuts or chocolate.\n");
 skin();
 printf("\nThe Skin Care Department and the Documentation was taken care by Mr.Shiv Vendra Singh :}");
 getch();
 system("cls");
 printf( "\nDO YOU KNOW?\nEating fairly large amounts of raisins and grapes can cause kidney failure in dogs\n\n");
 DEV();
 printf("\nThe Blood Group Department and the Calorie System was taken care by Mr.Devyansh Roy :}");
 getch();
 system("cls");
 routine();
 printf("\nThe Wellness Routine Department along with the compilation was taken care by Mr.Laukik Saxena :}");
 getch();
 system("cls");
fclose(data);
}
